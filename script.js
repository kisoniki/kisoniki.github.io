...
function carregarVersosIniciais() {
    const versosPorNome = {
        ...
        'Coral da Agonia|Blxck': [
            'Olha quem tá de volta','Mas agora eu descobri tudo','Eu tento fugir, mas nada adianta'
        ],
        'Agente do Caos|Blxck': [
            'Ele está acordando','Quer saber se eu sou mal?','Não vai restar um mundo para ser dominado'
        ],
        'Inferno de Gelo|Blxck': [
            'Comigo não se preocupa, nem um pouco?','Segure ela firmemente','Nem tenho mais coração, mas ainda o sinto batendo'
        ],
        'Perfeição|Blxck': [
            'É perda de tempo bloquear','Eu larguei todo o ego','Pra vencê-los, só alguém louco'
        ],
        'Maldição|Blxck': [
            'Porque eu já perdi tudo!','Duas mãos e uma delas defende','De novo, não'
        ],
        'Frio|Blxck': [
            'Por acaso tá me procurando?','Você tá com medo? Por que se escondeu?','E é tão linda quando desabrocha'
        ],
        'Canônico|Blxck': [
            'Alguém tá bem longe de casa','E você é o culpado disso','Todos nós passamos por isso'
        ],
        'Anoitecer Cruel|Blxck': [
            'Mas tudo mudou naquele dia','Um turbilhão de golpes que te ataca','E é tão perturbador!'
        ],
        'A criança demônio|Blxck': [
            'Não tenho medo de morrer lutando','Nunca foi questão de sorte','Vou morrer sem lutar...'
        ],
        'O Rei Voltou|Blxck': [
            'Vejo que o tempo te tornou fraco','Eu sou o seu salvador','A realidade em minha mão'
        ],
        'Invisível|Blxck': [
            'Mas sem pressa, por favor','Bando de fracassados, seria','Correntes que giram'
        ],
        'Mr. 0|Blxck': [
            'A ampulheta marca pouco tempo...','Deveria ser um pecado!','Mas que tal esse jogo virar?'
        ],
        'Pressão|Blxck': [
            'Então deixa eu explicar pra você','Você não é como antes','Não é tudo que eu sou capaz'
        ],
        'Solidão|Blxck': [
            'Eu sou só uma ferramenta nessa guerra','A confiança de ser o homem mais forte do mundo','Acho que finalmente entendi esse papo'
        ],
        'Vilão|Blxck': [
            'Só se curva, seu lixo','Então relaxa, que eu te ensino como faz','Eu esmago três'
        ],
        'Casca vazia|Blxck': [
            'Citam contos sobre a escuridão','Vagando sozinho','Lordes se curvaram'
        ],
        'Rei dos Reis|Blxck': [
            'Pavimentei o meu próprio caminho','Mais humildade, por favor','Pelo meu nome eles gritam'
        ],
        'O escolhido|Blxck': [
            'Então observa calado','Saiba, eu tô confiando em você','Só não demore, ou eu perco o interesse'
        ],
        'Deus|Daarui': [
            'Que comece esse festival!','Todos me temem, sou imortal','Humanos, afundem nos mares'
        ],
        'Como Um Trovão|Daarui': [
            'Não deixe o medo borrar sua visão','Você ficou bem nojento','Não se engane, não vim pra conversar'
        ],
        'La Pantera|Daarui': [
            'Com um só golpe, eu teria o destruído','Eu não tenho piedade, remorso ou clemência','Quis me matar com um poder menor que o meu'
        ],
        'Monarca Das Sombras|Daarui': [
            'Por que eu despertei tão fraco?','Não foi um sonho, só uma sorte extraordinária','Não mais humano? Sério!'
        ],
        'Luar Superior|Daarui': [
            'Isso é tão nostálgico','Partirei sem arrependimentos','Eu não fugiria de mais nada!'
        ],
        'East Blue|Daarui': [
            'Cê nem sabe o que é um tesouro','Você nunca seria bom como eu sou','Nossa diferença é raça, é impossível competir'
        ],
        'O Rei|Daarui': [
            'Mas é bom não se esquecer','Tudo em pedaços de repente','Olha o caos que a gente acabou de fazer'
        ],
        'O Infinito|Daarui': [
            'Cê tentou me matar...?','Não entendi esse cara','O ódio que eu tinha está sumindo'
        ],
        'Terceiro Lua|Daarui': [
            'A própria natureza, eu sempre os odiei','Me enfrentar não será tão fácil','Mas vou cumprir essa'
        ],
        'O Homem Que Vale 1 Bilhão|Daarui': [
            'Cada traidor na dor irá ruir','Essa é a punição por entrar em nossa ilha!','Toda sua tentativa é só um desejo fútil'
        ],
        'Lua Superior Três|M4rkim': [
            'Nojo do sabor dos fracos','Só tô elogiando, não fique irritado','Por que estou lutando se eu já perdi?'
        ],
        'Mochi Mochi|Enygma': [
            'Só desiste','A morte vai os separar','Você está vendo muito no futuro'
        ],
        'All Blue|Enygma': [
            'Eu tenho um sonho','Quando que do meu sonho eu desisti?','O bolo que eu vou fazer vai ser de matar'
        ],
        'O PODER DA MINHA IRA 2|7 Minutoz': [
            'Eu tô ficando louco','Mirei bem na sua cara','Achei que tinham entendido'
        ],
        'UMA BIJUU SEM CAUDA|7 Minutoz': [
            'Eu sou um peixe','Ímpar ou par?','Um predador foi o que eu me tornei'
        ],
        'MAIS NINGUÉM VAI SOFRER O QUE EU SOFRI|7 Minutoz': [
            'Eu tô no inferno','Eu quero criar uma realidade onde isso não aconteça','Mesmo que eu tenha que corromper minha alma'
        ],
        'ME TORNEI UM DEUS|7 Minutoz': [
            'Mas não foi isso que aconteceu','Olhe pra mim','Quem manda aqui sou eu!'
        ],
        'VAI COMEÇAR O RITUAL|7 Minutoz': [
            'Chora não','Eu sou maluco, mano, cê não aguenta','Esse fumante arrancou minha cabeça'
        ],
        'ACHOU QUE EU TINHA MORRIDO|7 Minutoz': [
            'Eu cobrei a minha dívida, tomei seus corações','Matei todos meus companheiros, nunca fui alguém normal','Eu vou te matar pra me tornar o que você era'
        ],
        'O DEMÔNIO DA NÉVOA OCULTA|7 Minutoz': [
            'Não é evidente?','Só caio se mil cair','Sua morte, minha morte, não vão ser em vão'
        ],
        'O SUCESSOR DO L|7 Minutoz': [
            'Minha mente é fora de série','Tive que derramar sangue','Isso é uma corrida'
        ],
        'O MAIOR DETETIVE|7 Minutoz': [
            'Você tirou essas vidas','Me diga quem é você','Esse erro pode causar minha morte'
        ],
        'O DEUS DO NOVO MUNDO|7 Minutoz': [
            'E agora eu vou rir no seu túmulo','Não há humano mais poderoso que eu','Você é inferior e por isso perdeu'
        ],
        'CAIXÃO DE AREIA|7 Minutoz': [
            'Alguém com uma defesa perfeita','Até saciar minha sede, eu não paro um segundo','Seu ódio é mais fraco que o meu!'
        ],
        'ITADORI|7 Minutoz': [
            'Tira o sapato antes de entrar no santuário','Eu já tive fome, e comi coisa bem pior','Acho que meu monstro assustou eles'
        ],
        'SUKUNA|7 Minutoz': [
            'Quem dera tudo isso fosse sobre mim','Eu já fiz muito sacrifício','Por poder, vale a solidão que ser o mais forte traz?'
        ],
        'SATORU GOJO|7 Minutoz': [
            'Equilibro o infinito','Me sentindo acima do mundo','Eles não podem nos tocar'
        ],
        'SUGURU GETO|7 Minutoz': [
            'Humanos nunca mudarão','Um mundo em espiral','Repetindo o ciclo'
        ],
        'MAHITO|7 Minutoz': [
            'Suas vidas não são especiais','O seu choro é canção pros meus ouvidos','Eu te permito'
        ],
        'CIRURGIÃO DA MORTE|7 Minutoz': [
            'Quem devia nos proteger, no fim, nos joga aos lobos','Se for pra sobreviver, ataco pelas costas','Por que não salvaria você também?'
        ],
        'DISStaque': [
    ...
    Object.entries(versosPorNome).forEach(([nome, versos]) => {
        const [nomeBase, artistaEspecifico] = nome.split('|').map(part => part.trim());
        const nomeBaseKey = nomeBase.toLowerCase();

        if (artistaEspecifico) {
            const chaveCompleta = `${nomeBaseKey}|${artistaEspecifico.toLowerCase()}`;
            versosMap[chaveCompleta] = versos;
        }

        if (!versosMap[nomeBaseKey]) {
            versosMap[nomeBaseKey] = versos;
        }
    });
    ...
    musicasDisponiveis.forEach(musica => {
        ...
        let versos = versosMap[keyFull] || versosMap[nomeKey];
